...
class ClassicsPipeline:
    ...
    async def run(self, topic: str | None = None) -> RenderResult:
        self.config.ensure_directories()
        self.logger.info("Starting Russian Classics Engine")

        story = self.story_engine.generate(topic)
