...
def test_gemini_key_rotation(monkeypatch):
    ...
    class FakeModels:
        ...
        def generate_content(self, **kwargs):
            ...
            return _FakeResponse(
                '{"title":"x","topic":"Guerra y paz","hook":"h","scenes":[{"index":1,"text":"a","image_prompt":"b"},{"index":2,"text":"a","image_prompt":"b"},{"index":3,"text":"a","image_prompt":"b"},{"index":4,"text":"a","image_prompt":"b"}],"ending_question":"q?","social":{"youtube_title":"yt","youtube_description":"yd","instagram_caption":"ig","tiktok_caption":"tt","hashtags":["#t"]}}'
            )
    ...
    story = provider.generate_story("Guerra y paz")

    assert story.topic == "Guerra y paz"
